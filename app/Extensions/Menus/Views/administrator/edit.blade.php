...
<div class="main-container" id="page-menus-add">
    ...
    [
        'items' => collect([['url' => url('administrator/menus'), 'title' => trans('menus::admin.menus_edit_manage')], ['url' => '', 'title' => trans('menus::admin.menus_edit_page_title')]])
    ])
    ...
    <div class="main-content" autoscroll="true">
        <section>
            <div class="page-header">
                <h2>
                    {{ trans('menus::admin.menus_edit_page_title') }}
                </h2>
                <p class="lead"> {{ trans('menus::admin.menus_edit_page_description') }}</p>
            </div>
            ...
            <div class="well">
                {!! Form::open(['class' => 'form-floating']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-default" type="button" onclick="location.href='{{ url('administrator/menus') }}'">{{ trans('menus::admin.menus_edit_cancel') }}</button>
                    </div>
                {!! Form::close() !!}
            </div>
