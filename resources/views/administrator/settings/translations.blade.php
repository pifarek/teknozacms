            ...
            <section>
                ...
                <div class="well">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('file', $files, $file, ['class' => 'form-control select-file selectpicker']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary" type="submit">@lang('admin.settings_translations_submit')</button>
                    </div>
                    {!! Form::close() !!}
