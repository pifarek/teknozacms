        ...
        <section>
            ...
            <div class="well">
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="variable-{{ $locale->language }}">
                        <div class="form-group{!! $errors->has('name-' . $locale->language)? ' has-error' : '' !!}">
                            ...
                            {!! Form::text('name-' . $locale->language, old('name-' . $locale->language, $contact->translate($locale->language)->name), ['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group{!! $errors->has('description-' . $locale->language)? ' has-error' : '' !!}">
                            ...
                            {!! Form::textarea('description-' . $locale->language, old('description-' . $locale->language, $contact->translate($locale->language)->description), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    @endforeach
                </div>
                <div class="form-group">
                    ...
                    {!! Form::text('street', old('street', $contact->street), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('postal', trans('contacts::admin.edit_postal'), ['class' => 'control-label']) !!}
                    {!! Form::text('postal', old('postal', $contact->postal), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('city', trans('contacts::admin.edit_city'), ['class' => 'control-label']) !!}
                    {!! Form::text('city', old('city', $contact->city), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('fax', old('fax', $contact->fax), ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
